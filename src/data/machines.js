export const machines = [
  {
    ...
    videos: [
      { src: 'https://videos.vendtechnz.co.nz/protein-1.mp4', label: 'Advertising', poster: '/assets/images/protein-thumb-1.png' },
      { src: 'https://videos.vendtechnz.co.nz/protein-2.mp4', label: 'Purchasing', poster: '/assets/images/protein-thumb-2.png' },
      { src: 'https://videos.vendtechnz.co.nz/protein-3.mp4', label: 'Machine Working', poster: '/assets/images/protein-thumb-3.png' },
    ],
    video: 'https://videos.vendtechnz.co.nz/protein-1.mp4',
